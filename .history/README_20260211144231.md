...
## Installation
- Install the [triqs_tprf](https://triqs.github.io/tprf/latest/install.html) package in a python venv (with default name "triqs"). Requires a TRIQS install. On Ubuntu there are precompiled packages. Otherwise this requires compilation described [here](https://triqs.github.io/triqs/3.3.x/install.html). 
